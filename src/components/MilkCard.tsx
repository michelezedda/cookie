...
const MilkCard = ({ name, description, pic, price, vegan, discount }) => {
  return (
    <div className="relative flex flex-col justify-end items-center text-center bg-stone-950 shadow-xl rounded-4xl p-6 h-90 w-80 gap-3">
      <img src={pic} alt={name} className="w-50 absolute -top-25" />
      <div className="absolute top-30 grid grid-cols-2 gap-4 w-[90%]">
        {vegan && (
